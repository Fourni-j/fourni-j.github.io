...
title: Terms
ios_app_id: 6751974055
include_in_header: false
app_name: reverseaudio
---
...
Welcome to the ReverseAudio App ("app", "we", "our", or "us"). By downloading, accessing, or using our app, you agree to abide by the following terms and conditions. If you do not agree with any part of these terms, please refrain from using the app.
...
This app is designed for personal, non-commercial use. You agree not to misuse the app or use it for any illegal or unauthorized purposes.
...
Thank you for choosing reverseaudio.